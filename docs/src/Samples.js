...
export default {
  ...
  StepsLeftBasic:                require('fs').readFileSync(__dirname + '/../examples/StepsLeftBasic.js', 'utf8'),
  StepsLeftAdvanced:             require('fs').readFileSync(__dirname + '/../examples/StepsLeftAdvanced.js', 'utf8'),
